...
public class Jogo extends Evento {
    ...
    public JogadorJogo getJogadorBarragemVencedorSimples() {
        return (JogadorJogo) getJogadorJogoVencedorSimples();
    }

    public JogadorJogo getJogadorBarragemPerdedorSimples() {
        return (JogadorJogo) getJogadorJogoPerdedorSimples();
    }
