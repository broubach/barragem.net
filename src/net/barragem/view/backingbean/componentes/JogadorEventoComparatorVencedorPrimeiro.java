...
public class JogadorEventoComparatorVencedorPrimeiro implements Comparator<JogadorEvento> {
	public int compare(JogadorEvento o1, JogadorEvento o2) {
		if (o1 instanceof JogadorJogo && Boolean.TRUE.equals(((JogadorJogo) o1).getVencedor())) {
			return -1;
		} else if (o2 instanceof JogadorJogo && Boolean.TRUE.equals(((JogadorJogo) o2).getVencedor())) {
			return 1;
