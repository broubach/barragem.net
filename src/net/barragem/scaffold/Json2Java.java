...
public class Json2Java {
	...
	**/
	protected List<Object> getList(String jsonResponse) {
		...
		if (jsonResponse.startsWith("[")) {
			...
			throw new RuntimeException("MalFormed JSON Array Response.");
		}
	...
	**/
	protected Map<String, Object> getMap(String jsonResponse) {
