...
function twitterCallback(twitters) {
  ...
  for (var i=0; i<twitters.length; i++){
    ...
    statusHTML.push(status.substring(0, 20)+'... <a href="http://twitter.com/'+username+'/statuses/'+twitters[i].id+'">'+relative_time(twitters[i].created_at)+'</a>');
  }
  document.getElementById('descricao').innerHTML = statusHTML.join('');
}
