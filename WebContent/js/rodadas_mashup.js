function rodadasCallback(barragem) {
	...
	html += "</tr></thead>";
	html += "<tr>";
	html += "<td style='border-bottom:1px solid #E3EAEE; padding:4px; text-align:left;'>Selecione uma rodada para visualizar os jogos.</td>";
	html += "</tr>";
	html += "</table>";
	html += "</div>";
...
function rodadaCallback(jogos) {
	for (var i=0; i<jogos.length; i++) {
		...
		for (var i=0; i<jogos.length; i++) {
			html += "<tr>";
			html += "<td style='border-bottom: 1px solid #E3EAEE; padding: 4px; text-align: left;'>" + jogos[i].jogador1 + "</td>";
			html += "<td style='border-bottom: 1px solid #E3EAEE; padding: 4px; text-align: left;'>" + jogos[i].pts1 + "</td>";
			html += "<td style='border-bottom: 1px solid #E3EAEE; padding: 4px; text-align: left;'>X</td>";
			html += "<td style='border-bottom: 1px solid #E3EAEE; padding: 4px; text-align: left;'>" + jogos[i].jogador2 + "</td>";
			html += "<td style='border-bottom: 1px solid #E3EAEE; padding: 4px; text-align: left;'>" + jogos[i].pts2 + "</td>";
			html += "<td style='border-bottom: 1px solid #E3EAEE; padding: 4px; text-align: left;'>" + jogos[i].placar + "</td>";
			html += "<td style='border-bottom: 1px solid #E3EAEE; padding: 4px; text-align: left;'>" + jogos[i].dataHora + "</td>";
			html += "</tr>";
		}
		html += "</tbody></table>";
